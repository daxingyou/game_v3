...
function UIResourceInfo:UpdataData()
    ...
    UIHelper:seekWidgetByName(panel_item, "LabelVal"):setString(tostring(PLAYER:get_basedata().money))

    --
    panel_item=self._root_widget:getChildByName("PanelItem2")
    UIHelper:seekWidgetByName(panel_item, "LabelVal"):setString(tostring(PLAYER:get_basedata().RMB))
    --
    panel_item=self._root_widget:getChildByName("PanelItem3")
    UIHelper:seekWidgetByName(panel_item, "LabelVal"):setString(string.format(StringData[890000003],
