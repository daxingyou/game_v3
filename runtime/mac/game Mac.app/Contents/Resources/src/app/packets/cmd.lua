...
return  {
	...
	--------------------------------------------------------------------------
	-- 任务
	{ id=29, name="SC_MissionList", 	file="mission.SC_MissionList"},
	{ id=30, name="SC_Mission", 		file="mission.SC_Mission"},
	{ id=31, name="SC_FlushMission", 	file="mission.SC_FlushMission"},
	{ id=32, name="CS_MissionOP",},
	--------------------------------------------------------------------------
	-- 邮件
	{ id=33, name="SC_MailRet", 		file="mail.SC_MailRet"},
	--------------------------------------------------------------------------
}
