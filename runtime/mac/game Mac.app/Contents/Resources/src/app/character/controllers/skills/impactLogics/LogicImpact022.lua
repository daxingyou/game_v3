...
function LogicImpact022:onBeforeBout(sender_obj,ownImpact)
    ...
    assert(target_logic~=nil and impact_id~=nil,"onBeforeBout() - failed() , impact_id is nil or target_logic is nil")
    -- 取得目标逻辑
    local conditions = CommonUtil:ToTargetConditions(target_logic)
    conditions.atk_dis = 1
    SkillLogic:getTarsByTarLogic(rMe,conditions,target_obj_views)
    --
